...
internal sealed class TelegramMessenger : IMessenger
{
    ...
    public async ValueTask StartReceivingAsync(CancellationToken cancellationToken)
    {
        ...
        _client = new TelegramBotClient(telegramOptions.BotToken);
        ...
        await _client.SendTextMessageAsync(
            telegramOptions.AdminChatToken,
            text: "Бот запущен!",
    ...
    private async Task HandleCallbackQuery(CallbackQuery query, CancellationToken cancellationToken)
    {
        ...
        var consumeRequest = new ConsumeUserMessageRequest
        {
            ...
            MessageType = Common.Models.MessageType.Query,
    ...
    private async Task HandleMessage(Message message, CancellationToken cancellationToken)
    {
        ...
        var request = new ConsumeUserMessageRequest
        {
            ...
            MessageType = Common.Models.MessageType.Unknown,
            Message = new MessageInfo
            {
        ...
        switch (message.Type)
        {
            case MessageType.Photo:
            {
                ...
                request.MessageType = Common.Models.MessageType.QrCode;
                break;
            }

            case MessageType.Text:
            {
                request.MessageType = Common.Models.MessageType.Text;
                break;
            }
        }
