...
internal class Program
{
    private static async Task Main(string[] args)
    {
        ...
        if (string.IsNullOrEmpty(settingsFrom.DataBaseConnectionString) ||
            string.IsNullOrEmpty(settingsTo.DataBaseConnectionString))
        ...
        where T : Entity
    {
        ...
        using var uowTo =
            new UnitOfWork(new ApplicationContext(settingsTo.DataBaseConnectionString, settingsTo.DataProviderType));
        ...
        using var uowFrom =
            new UnitOfWork(new ApplicationContext(settingsFrom.DataBaseConnectionString,
                settingsFrom.DataProviderType));
