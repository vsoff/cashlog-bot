...
public sealed class ApplicationContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ReceiptConsumerMapDto>().HasOne(x => x.Consumer).WithMany(x => x.ConsumerReceiptMaps)
            .OnDelete(DeleteBehavior.Restrict);
        modelBuilder.Entity<ReceiptConsumerMapDto>().HasOne(x => x.Receipt).WithMany(x => x.ConsumerMaps)
            .OnDelete(DeleteBehavior.Restrict);
