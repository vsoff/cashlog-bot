...
public sealed class ApplicationContext : DbContext
{
    ...
    {
        modelBuilder
            .Entity<ReceiptConsumerMap>()
            .ToTable(nameof(ReceiptConsumerMaps));
        modelBuilder
            .Entity<ReceiptConsumerMap>()
            .HasOne(x => x.Consumer)
        ...
        modelBuilder
            .Entity<MoneyOperation>()
            .ToTable(nameof(MoneyOperations));
        modelBuilder
            .Entity<MoneyOperation>()
            .HasOne(x => x.BillingPeriod)
