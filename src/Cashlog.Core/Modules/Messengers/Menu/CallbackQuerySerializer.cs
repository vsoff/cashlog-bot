...
public class QueryDataSerializer : IQueryDataSerializer
{
    ...
    private readonly Dictionary<MenuType, Type> _typeMap = new()
    {
    ...
    public IQueryData DecodeBase64(string base64)
    {
        ...
        if (_typeMap.ContainsKey(rawData.Type))
            return (IQueryData)ProtoSerializerHelper.Deserialize(_typeMap[rawData.Type], rawData.Data,
...
{
    [ProtoMember(1)] public MenuType Type { get; set; }
