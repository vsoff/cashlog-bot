...
public class MoneyTransferQueryData : IQueryData
{
    ...
    [ProtoMember(4)] public long? CustomerFromId { get; set; }

    [ProtoMember(5)] public long? CustomerToId { get; set; }

    [ProtoMember(6)] public long? TargetId { get; set; }

    [ProtoMember(7)] public int Amount { get; set; }

    [ProtoMember(8)] public string Caption { get; set; }
